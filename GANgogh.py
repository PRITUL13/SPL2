...
BATCH_SIZE = 98 # Batch size. Must be a multiple of CLASSES and N_GPUS
...
with tf.Session(config=tf.ConfigProto(allow_soft_placement=True)) as session:
    ...
    lib.save_images.save_images(_x_r.reshape((BATCH_SIZE, 3, 64, 64)), 'F:/GANGogh-master/generated/spl.png')
