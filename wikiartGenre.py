...
path = os.path.normpath('F:/GANGogh-master/misc/smallimagesimages')

#This dictionary should be updated to hold the absolute number of images associated with each genre used during training
styles = {'abstract': 14947,
          'animal-painting': 1788,
          'cityscape': 6583,
          'figurative': 4477,
          'flower-painting': 1796,
          'genre-painting': 14810,
          'landscape': 14940,
          'marina': 1794,
          'mythological-painting': 2076,
          'nude-painting-nu': 2972,
          'portrait': 14847,
          'religious-painting': 8235,
          'still-life': 2973,
          'symbolic-painting': 2988}
